...
if __name__ == "__main__":
    ...
    doFig6 = False
    doFig7 = False
    doFig13 = False # Computation intensive, data is included in repo.
    doBottPhaseDiagram = False

    Lx = Ly = 24 # Adjust for quicker/slower computation. Figures in the manuscript are done using Lx = Ly = 25 
    ...
    # Fig 13 (a-e)
    if doFig13: 
        plot_disorder_figure(1.0, -1.0, 'onsite', 0.50, 100, doInterpolation=doInterpolation)
    ...
    # Fig 13 (f-j)
    if doFig13: 
        plot_disorder_figure(1.0, -1.0, 'mass', 0.25, 100, doInterpolation=doInterpolation)
    ...
    # Fig 13 (k-o)
    if doFig13: 
        plot_disorder_figure(1.0, -1.0, 'hopping', 0.25, 100, doInterpolation=doInterpolation)
